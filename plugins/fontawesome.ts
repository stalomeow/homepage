...
import { faEnvelope, faCircleInfo, faMugSaucer, faBook } from '@fortawesome/free-solid-svg-icons'
...
library.add(faEnvelope, faCircleInfo, faMugSaucer, faGithub/*, faBilibili*/, faTelegram, faWeixin, faAlipay, faBook)
