...
import { faEnvelope, faNoteSticky, faMugSaucer } from '@fortawesome/free-solid-svg-icons'
...
library.add(faEnvelope, faNoteSticky, faMugSaucer, faGithub, faBilibili, faTelegram, faWeixin, faAlipay)
